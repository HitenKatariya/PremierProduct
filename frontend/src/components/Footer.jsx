        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/premier_products_logo_new.svg" alt="Premier Products" className="h-10 w-20 object-contain" />
              <div>
                <h3 className="text-xl font-bold text-white">Premier Products</h3>
